...
class __TwigTemplate_fb00b5bdd2bb5ab705f35cb3aa430599 extends Template
{
    private $source;
    private $macros = [];
...
\t";
        // line 14
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 14, $this->source); })()), "oldPassword", [], "any", false, false, false, 14), 'row');
        echo "
\t";
        // line 15
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 15, $this->source); })()), "newPassword", [], "any", false, false, false, 15), 'row');
        echo "
\t";
        // line 16
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 16, $this->source); })()), "confirmNewPassword", [], "any", false, false, false, 16), 'row');
        echo "
\t";
        // line 17
...
";
    ...
    {
        return array (  127 => 17,  123 => 16,  119 => 15,  115 => 14,  111 => 13,  107 => 12,  103 => 11,  99 => 10,  93 => 7,  89 => 5,  79 => 4,  59 => 2,  36 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{% extends 'base.html.twig' %}
{% block title %}Modifier mon mot de passe - Ma boutique
{% endblock %}
{% block content %}
...
\t<hr>
{% endblock %}
", "account/password.html.twig", "/Applications/MAMP/htdocs/myboutique/templates/account/password.html.twig");
    }
}
