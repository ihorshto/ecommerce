...
class __TwigTemplate_de9f2585bd0f50add3d5e97d70cafb7d extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t<p>";
        // line 17
        echo twig_striptags(twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 17, $this->source); })()), "description", [], "any", false, false, false, 17), "<br><strong>");
        echo "</p>
...
";
    ...
    {
        return array (  124 => 20,  119 => 17,  113 => 14,  109 => 13,  105 => 12,  97 => 9,  93 => 7,  83 => 6,  69 => 3,  59 => 2,  36 => 1,);
    }
...
\t\t\t<a href=\"\" class=\"btn btn-primary\">Ajouter au panier</a>
\t\t\t{# <a href=\"href=\"{{ path('product', {'slug': product.slug}) }}\"\" class=\"btn btn-primary\">Ajouter au panier</a> #}
\t\t</div>
\t</div>
{% endblock %}
